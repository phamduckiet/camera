               ...
               <!-- Product Details Left -->
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="{{$value->image}}" data-gall="myGallery">
                    ...
                    <div class="product-details-thumbs slider-thumbs-1">
                        <div class="sm-image"><img src="{{$value->image}}" alt="product image thumb"></div>
                ...
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        ...
                        <div class="price-box pt-20">
                            <span class="new-price new-price-2">{{ number_format($value->price, 0, '.', ',') . " đ"}}</span>
